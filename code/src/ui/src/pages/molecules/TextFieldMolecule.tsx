...
import { DesignSystem, TextFields } from '@finos/a11y-theme-builder-sdk';
...
export const TextFieldMolecule: React.FC<Props> = ({ molecule, designSystem }) => {
    ...
    useEffect(() => {
        console.log("TextFieldMolecule mounted");
    }, []);
